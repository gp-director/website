        ...
        <div className="container">
          ...
          >
            ...
            <p className="cta-description">
              Follow us on social media for the latest updates, industry insights, and product announcements.
            </p>
            <div className="social-links" style={{ display: 'flex', justifyContent: 'center', gap: '2rem', marginTop: '2rem' }}>
              <a href="#" className="social-link" style={{ transition: 'color 0.3s ease' }} onMouseEnter={(e) => e.currentTarget.style.color = '#000'} onMouseLeave={(e) => e.currentTarget.style.color = 'currentColor'}>
